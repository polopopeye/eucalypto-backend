...
__decorate([
    (0, class_validator_1.IsNotEmpty)(),
    (0, swagger_1.ApiProperty)({ description: `Type of the category` }),
    __metadata("design:type", String)
], CreateCategoriesDto.prototype, "type", void 0);
__decorate([
    (0, class_validator_1.IsNotEmpty)(),
    (0, swagger_1.ApiProperty)({ description: `Is this  category published?` }),
    __metadata("design:type", Boolean)
], CreateCategoriesDto.prototype, "published", void 0);
exports.CreateCategoriesDto = CreateCategoriesDto;
class GetCategoriesDto extends CreateCategoriesDto {
}
__decorate([
    (0, class_validator_1.IsEmpty)(),
    (0, swagger_1.ApiProperty)({ description: `Date of creation` }),
    __metadata("design:type", firestore_1.Timestamp)
], GetCategoriesDto.prototype, "createdAt", void 0);
__decorate([
    (0, class_validator_1.IsEmpty)(),
    (0, swagger_1.ApiProperty)({ description: `Date of last update` }),
    __metadata("design:type", firestore_1.Timestamp)
], GetCategoriesDto.prototype, "updatedAt", void 0);
exports.GetCategoriesDto = GetCategoriesDto;
class UpdateCategoriesDto extends (0, swagger_1.PartialType)(GetCategoriesDto) {
}
exports.UpdateCategoriesDto = UpdateCategoriesDto;
//# sourceMappingURL=categories.dtos.js.map